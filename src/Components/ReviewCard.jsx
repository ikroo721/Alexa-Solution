...
useEffect(() => {
  ...
  return (
    <div
    style={{backgroundColor:bg ,color:text,'--rotation': `${First}`}} className={`transition-all duration-700 ease-in-out h-[330px] w-[330px] sm:h-[450px] sm:w-[450px]  xsm:h-[430px] xsm:w-[430px] lmd:h-[450px] lmd:w-[450px] md:h-[450px] md:w-[450px] slg:h-[280px] slg:w-[230px] lg:h-[300px] lg:w-[300px] ml-0 sxl:h-[400px] sxl:w-[400px] xl:h-[430px] xl:w-[430px]  
